...
final class MessageSnapshot {
    ...
    static MessageSnapshot pattern(final Pattern pattern) {
        return new MessageSnapshot(null, pattern);
    }
    ...
    private boolean equals(final MessageSnapshot other) {
    ...
    public boolean equals(final Object other) {
        ...
        return equals((MessageSnapshot) other);
    }
