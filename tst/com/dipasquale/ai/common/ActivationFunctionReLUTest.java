...
public final class ActivationFunctionReLUTest {
    ...
    private static byte[] serialize(final ActivationFunctionReLU activationFunction)
            throws IOException {
    ...
    private static ActivationFunctionReLU deserialize(final byte[] activationFunction)
            throws IOException, ClassNotFoundException {
        try (ByteArrayInputStream inputStream = new ByteArrayInputStream(activationFunction);
             ObjectInputStream objectInputStream = new ObjectInputStream(inputStream)) {
            return (ActivationFunctionReLU) objectInputStream.readObject();
        }
    }
    ...
    public void TEST_3() {
        try {
            ...
            ActivationFunctionReLU result = deserialize(activationFunction);
