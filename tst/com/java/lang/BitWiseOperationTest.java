...
public final class BitWiseOperationTest {
    ...
    public void TEST_1() {
        ...
        Assert.assertEquals(-1L, Long.MIN_VALUE | Long.MAX_VALUE);
        ...
        Assert.assertEquals(Integer.MAX_VALUE, (int) (Long.MAX_VALUE >> 32));
        Assert.assertEquals(Integer.MAX_VALUE, (int) ~(1L << 31));
