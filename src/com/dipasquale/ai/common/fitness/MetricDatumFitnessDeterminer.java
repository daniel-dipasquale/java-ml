...
import com.dipasquale.metric.LazyPercentileMetricDatum;
...
final class MetricDatumFitnessDeterminer implements FitnessDeterminer, Serializable {
    ...
    private final MetricDatum metricDatum = new LazyPercentileMetricDatum(); // TODO: improve this if possible
