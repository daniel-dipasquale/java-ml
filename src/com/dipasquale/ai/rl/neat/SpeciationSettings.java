...
public final class SpeciationSettings {
    ...
    ContextObjectSpeciationSupport create(final InitializationContext initializationContext, final GeneralSettings generalSettings) {
        return ContextObjectSpeciationSupport.create(initializationContext, this, generalSettings);
    }
}
