...
final class DefaultNeatContextMetricsSupport implements NeatContext.MetricsSupport {
    private final DefaultNeatContextMetricsParameters params;
    ...
    static DefaultNeatContextMetricsSupport create(final NeatInitializationContext initializationContext, final MetricsSettings metricsSettings, final SpeciationSettings speciationSettings) {
        DefaultNeatContextMetricsParameters params = DefaultNeatContextMetricsParameters.builder()
        ...
        return new DefaultNeatContextMetricsSupport(params, metricDatumFactory, metricsContainer, metricsCollector, iteration, generation, allIterationMetrics);
    }

    @Override
    public NeatContext.MetricsParameters params() {
        return params;
    }

    @Override
    public void collectAllSpeciesCompositions(final Iterable<Species> allSpecies) {
        metricsCollector.collectAllSpeciesCompositions(metricsContainer, allSpecies);
    }
    ...
    static DefaultNeatContextMetricsSupport create(final SerializableStateGroup stateGroup, final ParallelEventLoop eventLoop) {
        DefaultNeatContextMetricsParameters params = stateGroup.get("metrics.params");
        ...
        MetricsContainer metricsContainer = createMetricsContainer(ParallelismSettings.extractThreadIds(eventLoop), metricDatumFactory, iterationMetrics);
