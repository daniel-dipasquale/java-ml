...
@Getter
final class ContextObjectRandomnessSupport implements Context.RandomnessSupport {
    ...
    static ContextObjectRandomnessSupport create(final InitializationContext initializationContext) {
        ...
        return new ContextObjectRandomnessSupport(generateIndexOrElementRandomSupport, isLessThanRandomSupport, shuffleRandomSupport);
    }
    ...
    static ContextObjectRandomnessSupport create(final SerializableStateGroup stateGroup) {
