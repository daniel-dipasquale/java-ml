...
final class DefaultNeatContextParallelismSupportMultiThread implements NeatContext.ParallelismSupport {
    ...
    private static void forEach(final InteractiveWaitHandleFactory interactiveWaitHandleFactory) {
        ...
        try {
            StrategyWaitHandle waitHandle = new StrategyWaitHandle(invokedWaitHandle, unhandledExceptions);
    ...
    private final class InternalParameters implements NeatContext.ParallelismParameters {
        @Override
