...
public final class StrategyRecurrentWeightFactory implements RecurrentWeightFactory, Serializable {
    @Serial
    private static final long serialVersionUID = 4439420908217479283L;
    private final FloatFactory modifierFactory;
    private final int size;

    public StrategyRecurrentWeightFactory(final FloatFactory modifierFactory, final RecurrentStateType recurrentStateType) {
