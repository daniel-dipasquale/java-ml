...
public final class DualModeRandomSupportFactory implements Serializable {
    ...
    private static RandomSupport createRandomSupport(final RandomType type) {
        ...
        return switch (type) {
            ...
            case QUADRUPLE_SIGMOID ->
                    new QuadrupleSigmoidRandomSupport(randomSupport, QUADRUPLE_SIGMOID_PLATEAU_AREA_RATE, QUADRUPLE_SIGMOID_PLATEAU_RANGE_RATE, QUADRUPLE_SIGMOID_STEEPENED_RATE);

            case QUADRUPLE_STEEPENED_SIGMOID ->
                    new QuadrupleSigmoidRandomSupport(randomSupport, QUADRUPLE_STEEPENED_SIGMOID_PLATEAU_AREA_RATE, QUADRUPLE_STEEPENED_SIGMOID_PLATEAU_RANGE_RATE, QUADRUPLE_STEEPENED_SIGMOID_STEEPENED_RATE);
        };
    }
