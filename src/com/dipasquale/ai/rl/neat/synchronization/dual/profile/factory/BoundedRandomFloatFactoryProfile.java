...
public final class BoundedRandomFloatFactoryProfile extends AbstractObjectProfile<FloatFactory> {
    ...
    public BoundedRandomFloatFactoryProfile(final boolean concurrent, final RandomType type, final float min, final float max) {
        super(concurrent, new DefaultFloatFactory(true, type, min, max), new DefaultFloatFactory(false, type, min, max));
    }
    ...
    private static final class DefaultFloatFactory implements FloatFactory, Serializable {
        ...
        private DefaultFloatFactory(final boolean concurrent, final RandomType type, final float min, final float max) {
