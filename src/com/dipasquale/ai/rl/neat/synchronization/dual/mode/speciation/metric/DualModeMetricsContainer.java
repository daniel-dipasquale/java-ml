...
import com.dipasquale.ai.rl.neat.speciation.metric.DefaultMetricsContainer;
...
public final class DualModeMetricsContainer implements MetricsContainer, DualModeObject, Serializable {
    ...
    private DefaultMetricsContainer metricsContainer;
    ...
    public DualModeMetricsContainer(final DualModeMapFactory mapFactory, final MetricDatumFactory metricDatumFactory) {
        ...
        this.metricsContainer = new DefaultMetricsContainer(mapFactory, metricDatumFactory);
    }
    ...
    private DefaultMetricsContainer createMetricsContainer() {
        ...
        return new DefaultMetricsContainer(mapFactory, metricDatumFactory, fitnessMetrics, generationMetrics, iterationMetrics);
    }
