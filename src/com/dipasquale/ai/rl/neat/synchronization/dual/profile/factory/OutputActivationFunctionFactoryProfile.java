...
public final class OutputActivationFunctionFactoryProfile extends AbstractObjectProfile<ActivationFunctionFactory> {
    @Serial
    private static final long serialVersionUID = -6687884858709091960L;

    public OutputActivationFunctionFactoryProfile(final boolean concurrent, final Pair<EnumFactory<OutputActivationFunctionType>> outputActivationFunctionTypeFactoryPair, final Pair<EnumFactory<ActivationFunctionType>> hiddenActivationFunctionTypeFactoryPair) {
        super(concurrent, new DefaultActivationFunctionFactory(true, outputActivationFunctionTypeFactoryPair.getLeft(), hiddenActivationFunctionTypeFactoryPair.getLeft()), new DefaultActivationFunctionFactory(false, outputActivationFunctionTypeFactoryPair.getRight(), hiddenActivationFunctionTypeFactoryPair.getRight()));
    }
    ...
    private static ActivationFunction create(final boolean concurrent, final EnumFactory<OutputActivationFunctionType> outputActivationFunctionTypeFactory, final EnumFactory<ActivationFunctionType> hiddenActivationFunctionTypeFactory) {
    ...
    private static final class DefaultActivationFunctionFactory implements ActivationFunctionFactory, Serializable {
        ...
        public ActivationFunction create() {
            return OutputActivationFunctionFactoryProfile.create(concurrent, outputActivationFunctionTypeFactory, hiddenActivationFunctionTypeFactory);
        }
    }
}
