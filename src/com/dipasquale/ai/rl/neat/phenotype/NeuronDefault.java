...
public final class NeuronDefault implements Neuron {
    ...
    public NeuronDefault(final NodeGene node, final Collection<NeuronInput> inputs, final Collection<NeuronOutput> outputs, final CircularVersionInt activationNumber) {
        this.node = node;
        this.inputs = inputs;
