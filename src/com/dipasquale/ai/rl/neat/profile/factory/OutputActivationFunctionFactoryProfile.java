...
public final class OutputActivationFunctionFactoryProfile extends AbstractObjectProfile<ActivationFunctionFactory> {
    ...
    public OutputActivationFunctionFactoryProfile(final boolean isOn, final Pair<EnumFactory<OutputActivationFunctionType>> outputActivationFunctionTypeFactoryPair, final Pair<EnumFactory<ActivationFunctionType>> hiddenActivationFunctionTypeFactoryPair) {
    ...
    private static final class DefaultActivationFunctionFactory implements ActivationFunctionFactory, Serializable {
        ...
        public ActivationFunction create() {
            return OutputActivationFunctionFactoryProfile.create(isOn, outputActivationFunctionTypeFactory, hiddenActivationFunctionTypeFactory);
        }
    }
}
