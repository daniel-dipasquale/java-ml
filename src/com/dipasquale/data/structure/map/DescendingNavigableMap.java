...
final class DescendingNavigableMap<TKey, TValue> implements NavigableMap<TKey, TValue> {
    ...
    public DescendingNavigableMap(final NavigableMap<TKey, TValue> navigableMap, final Comparator<? super TKey> comparator, final SubIterable<TKey, TValue> iterable) {
