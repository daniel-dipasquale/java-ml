...
final class NavigableKeySet<TKey, TValue> extends KeySet<TKey, TValue> implements NavigableSet<TKey> {
    ...
    public NavigableKeySet(final NavigableMap<TKey, TValue> navigableMap, final OrderedIterable<TKey, TValue> iterableOrdered, final boolean ascending, final SubIterable<TKey, TValue> iterableSub) {
        super(navigableMap, () -> iterableOrdered.iterator(ascending));
