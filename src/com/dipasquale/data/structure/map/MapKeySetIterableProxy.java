...
final class MapKeySetIterableProxy<TKey, TValue> extends MapKeySet<TKey, TValue> {
    @Serial
    ...
    MapKeySetIterableProxy(final AbstractMap<TKey, TValue> map, final Iterable<Map.Entry<TKey, TValue>> iterable) {
        super(map);
