...
final class AtomicLongArrayBloomFilter<T> implements BloomFilter<T>, Serializable {
    ...
    AtomicLongArrayBloomFilter(final MultiHashingFunction multiHashingFunction, final int size, final int hashingFunctionCount) {
    ...
    public boolean mightContain(final T item) {
        ...
        return flags.cardinality() == hashingFunctionCount;
    }
