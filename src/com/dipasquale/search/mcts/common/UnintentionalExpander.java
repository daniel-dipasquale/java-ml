...
public final class UnintentionalExpander<TAction extends Action, TEdge extends Edge, TState extends State<TAction, TState>> implements Expander<TAction, TEdge, TState> {
