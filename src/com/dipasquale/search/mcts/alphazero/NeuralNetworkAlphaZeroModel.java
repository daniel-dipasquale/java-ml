...
public final class NeuralNetworkAlphaZeroModel<TAction extends Action, TState extends State<TAction, TState>, TNeuronMemory extends NeuronMemory> implements AlphaZeroModel<TAction, TState> {
    ...
    private final NeuralNetworkDecoder<AlphaZeroPrediction<TAction, TState>, NeuralNetworkAlphaZeroModelContext<TAction, TState>> decoder;
    ...
    public NeuralNetworkAlphaZeroModel(final NeuralNetworkEncoder<TState> encoder, final NeuralNetworkDecoder<AlphaZeroPrediction<TAction, TState>, NeuralNetworkAlphaZeroModelContext<TAction, TState>> decoder, final NeuralNetwork<TNeuronMemory> neuralNetwork, final AlphaZeroValueCalculator<TAction, TState> valueCalculator, final AlphaZeroPolicyDistributor<TAction, TState> policyDistributor) {
    ...
    public AlphaZeroPrediction<TAction, TState> predict(final SearchNode<TAction, AlphaZeroEdge, TState> node, final EdgeFactory<AlphaZeroEdge> edgeFactory) {
        ...
        NeuralNetworkAlphaZeroModelContext<TAction, TState> context = new NeuralNetworkAlphaZeroModelContext<>(node, edgeFactory, valueCalculator, policyDistributor);
