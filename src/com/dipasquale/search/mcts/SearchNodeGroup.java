...
public interface SearchNodeGroup<TAction, TEdge extends Edge, TState extends State<TAction, TState>, TSearchNode extends SearchNode<TAction, TEdge, TState, TSearchNode>> extends Iterable<TSearchNode> {
    int size();
    ...
    default void shuffle(final RandomSupport randomSupport) {
        for (int i = size(); i > 1; i--) {
            int fromIndex = i - 1;
            int toIndex = randomSupport.nextInteger(0, i);
