package com.dipasquale.common.profile.factory;
...
public final class CyclicFloatFactoryProfile extends AbstractObjectProfile<FloatFactory> {
    ...
    private CyclicFloatFactoryProfile(final boolean isOn, final List<Pair<FloatFactory>> floatFactoryPairs, final AtomicInteger index) {
    ...
    public CyclicFloatFactoryProfile(final boolean isOn, final Iterable<Pair<FloatFactory>> floatFactoryPairs, final int index) {
        this(isOn, ImmutableList.copyOf(floatFactoryPairs), new AtomicInteger(index));
    }

    public CyclicFloatFactoryProfile(final boolean isOn, final Iterable<Pair<FloatFactory>> floatFactoryPairs) {
    ...
    private static final class DefaultFloatFactory implements FloatFactory, Serializable {
        ...
        @Override
        public float create() {
            return CyclicFloatFactoryProfile.create(index, floatFactoryPairs, floatFactoryAccessor);
        }
    }
}