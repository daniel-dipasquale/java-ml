...
public final class ArgumentValidatorSupport {
    ...
    public static void ensureGreaterThanOrEqualTo(final float actual, final float expected, final String name, final String additionalMessage) {
    ...
    public static void ensureGreaterThanOrEqualTo(final float actual, final float expected, final String name) {
        ensureGreaterThanOrEqualTo(actual, expected, name, null);
    }
    ...
    public static void ensureGreaterThan(final float actual, final float expected, final String name, final String additionalMessage) {
        if (Float.compare(actual, expected) <= 0) {
    ...
    public static void ensureGreaterThan(final float actual, final float expected, final String name) {
        ensureGreaterThan(actual, expected, name, null);
    }
    ...
    public static void ensureGreaterThanOrEqualToZero(final float actual, final String name) {
        ensureGreaterThanOrEqualTo(actual, 0f, name);
    }
    ...
    public static void ensureGreaterThanZero(final float actual, final String name, final String additionalMessage) {
        ensureGreaterThan(actual, 0D, name, additionalMessage);
    }

    public static void ensureGreaterThanZero(final float actual, final String name) {
        ensureGreaterThanZero(actual, name, null);
    }
    ...
    public static void ensureLessThanOrEqualTo(final float actual, final float expected, final String name, final String additionalMessage) {
        if (Float.compare(actual, expected) > 0) {
    ...
    public static void ensureLessThanOrEqualTo(final float actual, final float expected, final String name) {
        ensureLessThanOrEqualTo(actual, expected, name, null);
    }
    ...
    public static void ensureLessThan(final double actual, final double expected, final String name, final String additionalMessage) {
        if (Double.compare(actual, expected) >= 0) {
            String message = String.format("%s '%f' cannot be greater than or equal to '%f'", name, actual, expected);
    ...
    public static void ensureLessThan(final double actual, final double expected, final String name) {
        ensureLessThan(actual, expected, name, null);
    }
